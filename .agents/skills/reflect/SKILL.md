---
name: reflect
description: Reflect on the current session and suggest improvements to AGENTS.md and invoked skills based on user corrections, repeated feedback, and patterns observed during interaction. Use when ending a session to encode lessons learned.
allowed-tools: Read Edit AskUserQuestion
---

# Reflect

Analyze the current session and suggest improvements to AGENTS.md and invoked skills based on patterns, feedback, and lessons learned.
...
- Gaps in any skills invoked in the session that led to misunderstandings
...
### Step 3: Generate Specific Improvements
